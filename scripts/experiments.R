...
exp_df <- here("_results/_data/experiments-main.csv") |>
...
pesky_df <- here("_results/_data/experiments-pesky_wasps.csv") |>
    read_csv(col_types = cols()) |>
...
base_df <- here("_results/_data/experiments-main.csv") |>
    read_csv(col_types = cols()) |>
    filter(observer != "LAN") |>
    rowwise() |>
